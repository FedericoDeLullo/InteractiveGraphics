...
let equippedWeaponMesh = null; // Aggiungi la mesh dell'arma equipaggiata
...
    // Imposta il callback per l'evento di scarto
...
    // Imposta il callback per l'evento di equipaggiamento
