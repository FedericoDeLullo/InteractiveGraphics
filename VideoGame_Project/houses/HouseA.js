...
import { Furniture } from './Furniture.js'; // Import the Furniture class to add furniture models.
...
const createStairs = (parent, collidableObjects, floorHeight, houseDepth, startPosition, orientation) => {
    ...
    for (let i = 0; i < numSteps; i++) {
        ...
        // Adjust position and rotation based on the specified orientation ('x', 'z', or 'z-reversed').
        if (orientation === 'x') {
...
export class HouseA {
    ...
    create() {
        ...
        houseGroup.position.copy(new THREE.Vector3(-60, 0, -60)); // Position the house in the scene.
        houseGroup.houseId = 'houseA'; // Assign a unique ID for identification.
        ...
        // Create the outer walls for the first floor.
        // The numbers used here are specific to the house design and might need adjustment.
        ...
        // Create the stairs leading to the second floor.
        ...
        // Create various internal walls and dividers.
        // These walls are likely creating rooms and other internal structures.
        ...
        // More walls with special materials. The naming and positioning here are custom to the design.
        ...
        // Even more walls for the upper floor.
        ...
        // Instantiate and add furniture to the house.
        // Each furniture item is created as an instance of the imported `Furniture` class.
        // The getObjectByName method is used to selectively show or hide specific furniture components.
        ...
        table1.scale.set(2, 2, 2); // Scale up the furniture for better visibility.
